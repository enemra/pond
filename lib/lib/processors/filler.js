        ...
        value: function addEvent(event) {
            ...
            if (this.hasObservers()) {
                (function () {
                    var emitList = [];
                    var d = event.data();
                    if (_this3._method === "zero" || _this3._method === "pad") {
                        var dd = _this3.constFill(d);
                        var e = event.setData(dd);
                        emitList.push(e);
                        _this3._previousEvent = e;
                    } else if (_this3._method === "linear") {
                        _this3.linearFill(event).forEach(function (e) {
                            emitList.push(e);
                        });
                    }

...
var Pipeline = function () {
    ...
    (0, _createClass3.default)(Pipeline, [{
        ...
        value: function fill(_ref) {
            ...
            var fieldSpec = _ref$fieldSpec === undefined ? null : _ref$fieldSpec;
            var _ref$method = _ref.method;
            var method = _ref$method === undefined ? "linear" : _ref$method;
            var _ref$limit = _ref.limit;
            var limit = _ref$limit === undefined ? null : _ref$limit;

            var prev = this._chainPrev();
            return this._append(new _filler2.default(this, { fieldSpec: fieldSpec, method: method, limit: limit, prev: prev }));
        }
    }, {
        key: "align",
        value: function align(fieldSpec, window, method, limit) {
            var prev = this._chainPrev();
            return this._append(new _aligner2.default(this, { fieldSpec: fieldSpec, window: window, method: method, limit: limit, prev: prev }));
        }
    }, {
        key: "rate",

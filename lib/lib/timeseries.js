...
var TimeSeries = function () {
        ...
        if (arg instanceof TimeSeries) {
            ...
            if (_underscore2.default.has(obj, "events")) {
                ...
                (function () {
                    ...
                    var _obj$utc = obj.utc;
                    var utc = _obj$utc === undefined ? true : _obj$utc;
                    var meta2 = (0, _objectWithoutProperties3.default)(obj, ["columns", "points", "utc"]); //eslint-disable-line
                    ...
                    var events = points.map(function (point) {
                        ...
                        switch (eventType) {
                            ...
                            case "index":
                                return new _indexedevent2.default(t, d, utc);
                            default:
    ...
    (0, _createClass3.default)(TimeSeries, [{
        ...
        value: function renameColumns(options) {
            ...
            var rename = function rename(event) {
                var renamedMap = function renamedMap(event) {
                    var b = {};
                    _underscore2.default.each(event.data().toJS(), function (value, key) {
                        var k = renameMap[key] || key;
                        b[k] = value;
                    });
                    return b;
                };

                var renamedData = renamedMap(event);

                if (event instanceof _event2.default) {
                    return new _event2.default(event.timestamp(), renamedData);
                } else if (event instanceof _timerangeevent2.default) {
                    return new _timerangeevent2.default([event.begin(), event.end()], renamedData);
                } else if (event instanceof _indexedevent2.default) {
                    return new _indexedevent2.default(event.index(), renamedData);
                }
            };
        ...
        value: function fill(options) {
            ...
            var fieldSpec = _options$fieldSpec === undefined ? null : _options$fieldSpec;
            ...
            if (method === "zero" || method === "pad") {
                ...
                fieldSpec.forEach(function (fieldPath) {
                    pipeline = pipeline.fill({ fieldSpec: fieldPath, method: method, limit: limit });
                });
            } else {
        ...
        value: function align(options) {
            ...
            var fieldSpec = _options$fieldSpec2 === undefined ? "value" : _options$fieldSpec2;
            var _options$period = options.period;
            var period = _options$period === undefined ? "5m" : _options$period;
            var _options$method2 = options.method;
            var method = _options$method2 === undefined ? "linear" : _options$method2;
            var _options$limit2 = options.limit;
            var limit = _options$limit2 === undefined ? null : _options$limit2;
        ...
        value: function rate() {
            ...
            var fieldSpec = _options$fieldSpec3 === undefined ? "value" : _options$fieldSpec3;
            var _options$allowNegativ = options.allowNegative;
            var allowNegative = _options$allowNegativ === undefined ? true : _options$allowNegativ;
        ...
        value: function fixedWindowRollup(options) {
            ...
            var _options$toEvents = options.toEvents;
            var toEvents = _options$toEvents === undefined ? false : _options$toEvents;
        ...
        value: function hourlyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toEvent = options.toEvent;
            var toEvent = _options$toEvent === undefined ? false : _options$toEvent;


            if (!aggregation || !_underscore2.default.isFunction(aggregation)) {
                throw new Error("aggregation function must be supplied, for example avg()");
            }
        ...
        value: function dailyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toEvents2 = options.toEvents;
            var toEvents = _options$toEvents2 === undefined ? false : _options$toEvents2;
        ...
        value: function monthlyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toEvents3 = options.toEvents;
            var toEvents = _options$toEvents3 === undefined ? false : _options$toEvents3;
        ...
        value: function yearlyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toEvents4 = options.toEvents;
            var toEvents = _options$toEvents4 === undefined ? false : _options$toEvents4;
        ...
        value: function _rollup(type, aggregation) {
            var toEvents = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        ...
        value: function timeseriesListReduce(options) {
            ...
            var fieldSpec = options.fieldSpec;
            var reducer = options.reducer;
            var data = (0, _objectWithoutProperties3.default)(options, ["seriesList", "fieldSpec", "reducer"]);
        ...
        value: function timeSeriesListMerge(options) {
            var reducer = _event2.default.merge;
            return TimeSeries.timeseriesListReduce((0, _extends3.default)({}, options, { reducer: reducer }));
        }
        ...
        value: function timeSeriesListSum(options) {
            var reducer = _event2.default.sum;
            return TimeSeries.timeseriesListReduce((0, _extends3.default)({}, options, { reducer: reducer }));
        }
    }]);
    return TimeSeries;
